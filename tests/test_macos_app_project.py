...
class MacOSAppProjectTests(unittest.TestCase):
    ...
    def test_coreml_client_emits_asr_diagnostics(self) -> None:
        ...
        self.assertIn("coreml_asr_stream_reset", source)
        self.assertIn("coreml_asr_latency_client_chunk", source)
        self.assertIn("coreml_asr_latency_model_window", source)
        self.assertIn("coreml_asr_latency_engine", source)
        self.assertIn("coreml_asr_latency_ui_event", source)
        self.assertIn("queue_ms", source)
        self.assertIn("vad_ms", source)
        self.assertIn("first_chunk_to_window_ms", source)
        self.assertIn("locator_ms", source)
        self.assertIn("reducer_ms", source)
    ...
    def test_macos_sources_define_desktop_app_surface(self) -> None:
        ...
        self.assertIn('StatusRow(title: "Latest ayah"', content_source)
        self.assertIn('StatusRow(title: "Next expected"', content_source)
        self.assertIn("viewModel.state.debugNextExpectedText", content_source)
