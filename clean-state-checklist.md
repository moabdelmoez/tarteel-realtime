...
- [ ] macOS native UI polish keeps the unified toolbar, keyboard commands, Surah search focus, URL/text drop-in, diagnostic drag-out, onboarding, event history, and Settings validation covered: `uv run python -B -m unittest tests.test_macos_app_project tests.test_ios_recitation_scope_ui tests.test_ios_websocket_client tests.test_ios_status_panel -v`, plus Swift client core tests and the macOS app build.
